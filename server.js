...
// Add some content to the Recipes Object
Recipes.create('chocolate milk', ['cocoa', 'milk', 'sugar']);
Recipes.create('tofu scramble', ['tofu', 'turmeric', 'tamari','tomatoes']);
Recipes.create('tortillas', ['maseca', 'water', 'salt']);

// when the root of this route is called with GET,
// return all the recipes in the Recipes Object
